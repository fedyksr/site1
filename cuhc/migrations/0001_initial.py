    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('board', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='topics', to='cuhc.board')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('topic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='post', to='cuhc.topic')),
            ],
        ),
    ]
